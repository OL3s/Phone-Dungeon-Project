...
namespace Combat
{
	// Enable polymorphism for different attack types
	[JsonPolymorphic(TypeDiscriminatorPropertyName = "$type")]
	[JsonDerivedType(typeof(MeleeAttack), "melee")]
	[JsonDerivedType(typeof(RangedAttack), "ranged")]
	[JsonDerivedType(typeof(BeamAttack), "beam")]
	[JsonDerivedType(typeof(AreaOfEffectAttack), "aoe")]
	[JsonDerivedType(typeof(SummonAttack), "summon")]
	[JsonDerivedType(typeof(ThrowAttack), "throw")]
	[JsonDerivedType(typeof(TeleportAttack), "teleport")]
	[JsonDerivedType(typeof(NoAttack), "none")]
